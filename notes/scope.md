...
* Class variables are the only variables that can share state between objects (ignoring global variables)
* This is highly problematic, especially when dealing with the expansion of scope via class inheritance
* Avoid class variables when possible, especially if a class has descendant classes
